            ...
            <div class="tab-pane" id="tab-reward">
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  ...
                  <?php foreach ($sort_order_product_cat_id as $id_category => $sotr_category) { ?>
                    <input type="hidden" name="sort_order_product_cat_id[<?php echo $id_category; ?>]" value="<?php echo $sotr_category; ?>" />
                  <?php } ?>
...
$('input[name=\'related\']').autocompleteplus({
<?php } else { ?>
