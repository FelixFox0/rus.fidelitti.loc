...
<div class="row product" id="content">
	<?php if ($thumb || $images) { ?>
        <div class="large-12 medium-12 small-12 columns product__center">
        <div class="slider5" id="element">
            <?php if ($images) { ?>
          <?php foreach ($images as $image) { ?>
                <a href="<?php echo $image['popup']; ?>" data-fancybox="group" data-caption="Caption #1" class="fancybox"><img src="<?php echo $image['popups']; ?>"></a>      
            <?php } ?>
             <?php } ?>
         </div>
        </div>
    <?php } ?>
      ...
      <?php } ?>	      
            ...
            <?php if ($quantity == 0){ ?>
            <div class="product__cart__button">
            ...
            <ul class="accordion" data-responsive-accordion-tabs="accordion medium-tabs large-accordion" id="3e5nyv-responsiveaccordiontabs" data-accordion data-allow-all-closed="true">
                ...
                <li class="accordion-item" data-accordion-item>
                  <a href="#" class="accordion-title">Детали</a>
                  <div class="accordion-content" data-tab-content>
                                ...
                                <?php foreach ($attribute_groups as $attribute_group) { ?>
                                        <?php foreach ($attribute_group['attribute'] as $attribute) { ?>
                                            <?php if(in_array($attribute['attribute_id'], array(16))) { ?>
                                                <div class="large-4"><?php echo $attribute['name']; ?>:</div>
                                                <div class="large-8"><?php echo $attribute['text']; ?></div>
                                            <?php }?>
                                        <?php }?>
                                <?php }?>
                                </div>
                ...
                <li class="accordion-item" data-accordion-item>
                  <a href="#" class="accordion-title">Размер</a>
                  <div class="accordion-content" data-tab-content>
...
$('.product__cart__button').on('click', function(){
$('.new-ref__block a')[0].click();
});
//--></script>
